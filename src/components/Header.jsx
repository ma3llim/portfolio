            ...
            <div className="fixed top-0 left-0 right-0 z-50 py-2 bg-indigo-900/80 backdrop-blur-md border-b border-white/10 transition-all duration-300 shadow-xl">
                <Container>
                    <div className="grid grid-cols-2 items-center">
                        <Link to="home" offset={-80} smooth={true} duration={500} className="w-[160px] h-[40px] flex items-center cursor-pointer">
                            <img className="w-[250px] h-[150px] object-contain" src="logo.svg" alt="Mohd Sameer Logo" />
                        </Link>
                        <nav className="flex items-center justify-end gap-6">
                            <ul className="hidden md:flex items-center gap-6 text-lg">
                                <li className="hover:text-primary transition">
                                    <Link to="home" offset={-80} smooth={true} duration={500} className="select-none cursor-pointer">
                                        Home
                                    </Link>
                                </li>
                                <li className="hover:text-primary transition">
